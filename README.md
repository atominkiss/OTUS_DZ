...
```
cd existing_repo
git remote add origin https://gitlab.com/atominkiss/otus_arh_pattern_dz_1.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/atominkiss/otus_arh_pattern_dz_1/-/settings/integrations)
